...
const UUID = process.env.UUID || '438c5603-f968-4cb1-810a-79fa734862b5'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'Z5@980915vpn';            // 获取节点的订阅路径
